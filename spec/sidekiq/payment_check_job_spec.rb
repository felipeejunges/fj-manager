...
RSpec.describe PaymentCheckJob, type: :job do
  describe "perform" do
    ...
    let(:client) { create(:client, payment_type: payment_type)}
    let(:invoice) { create(:client_invoice, status: :generating, payment_type: payment_type, client: client) }
    ...
    describe "schedules the next PaymentCheckJob if payment check is" do
