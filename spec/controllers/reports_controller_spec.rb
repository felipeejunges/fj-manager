...
RSpec.describe ReportsController, type: :controller do
  ...
  describe 'GET #new_clients' do
    ...
    it 'filters clients based on payment type and date range' do
      ...
      get :new_clients, params: { payment_type: 'credit_card', start_date: Date.today, end_date: Date.tomorrow }
  ...
  describe 'GET #clients_invoiced_yesterday' do
    it 'assigns clients with invoices from yesterday to @clients' do
      ...
      invoice = create(:client_invoice, client:, reference_date: Date.yesterday, invoice_value: 100, status: :generated)
    ...
    it 'filters clients based on payment type and document type' do
      ...
      create(:client_invoice, client: client_with_payment_type, invoice_value: 1000, reference_date: Date.yesterday, status: :payed)
  ...
  describe 'GET #clients' do
    ...
    it 'filters clients based on payment type, status, and document type' do
      ...
      create(:client_invoice, client: client_with_options, invoice_value: 1000, reference_date: Date.today, status: :generated)
